...
const projectPostSchema = new mongoose.Schema({
    ...
    category: { type: String, enum: ['Web Development', 'Mobile App', 'Design', 'Content Writing', 'Marketing', 'Other'], required: true },
    ...
    selected_freelancer_id: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
    selected_freelancer_name: { type: String },
    bids_count: { type: Number, default: 0 },
